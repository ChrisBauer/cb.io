...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	    ...
	    var HeaderSinks = (0, _header2.default)(sources);
	    var HeaderVTree = HeaderSinks.DOM;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Header(sources) {
	    ...
	    var FRONT_ENDS_URL = 'http://chrisbauer.io:9000/rethink/frontEnds';
	    var request$ = _rx.Observable.just({ url: FRONT_ENDS_URL });
	    var frontEnds$ = sources.HTTP.filter(function (res$) {
	        return res$.request.url === FRONT_ENDS_URL;
